# opensource network analysis with openstreetmap

# using python to conduct basic network analysis across auckland
# includes downloading of network data from from openstreetmap (osm), cleaning + wrangling, then some basic routing
